...
<?php $__env->startSection('content_header'); ?>
    <h1>Editar Ficha #<?php echo e($fichadecaracterizacion->NIS); ?></h1>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card card-primary">
                ...
                <form action="<?php echo e(route('Fichas.update', $fichadecaracterizacion)); ?>" method="POST" class="form-guardar">
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('NIS', $fichadecaracterizacion->NIS)); ?>" required 
                                >
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('Codigo', $fichadecaracterizacion->Codigo)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('Denominacion', $fichadecaracterizacion->Denominacion)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('Cupo', $fichadecaracterizacion->Cupo)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('FechaInicio', optional($fichadecaracterizacion->FechaInicio)->format('Y-m-d'))); ?>"
                                required>
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('FechaFin', optional($fichadecaracterizacion->FechaFin)->format('Y-m-d'))); ?>"
                                required>
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('Observaciones', $fichadecaracterizacion->Observaciones)); ?></textarea>
