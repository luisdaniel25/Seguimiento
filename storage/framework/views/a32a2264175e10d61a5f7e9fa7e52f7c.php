    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card card-primary">
                ...
                <form action="<?php echo e(route('Fichas.store')); ?>" method="POST" class="form-guardar">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            <label>Cupo *</label>
                            <input type="number" name="Cupo" class="form-control <?php $__errorArgs = ['Cupo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('Cupo')); ?>" min="1" required>
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('FechaInicio')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('FechaFin')); ?>"
                                required>
